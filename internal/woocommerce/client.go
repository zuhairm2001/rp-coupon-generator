...
//take in relevant form data as and use to in json request

//then create request to woocommerce api
...
func (c *Client) CreateCoupon(ctx context.Context, amount int, minimumAmount float64) (*models.CouponResponse, error) {
	...
	couponReq := models.CouponRequest{
		...
		MinimumAmount:    fmt.Sprintf("%.2f", minimumAmount),
	}
